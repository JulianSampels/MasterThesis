...
3. train pathe2Phases small-codex without wandb
   - `python -m PathE.pathe.runner train pathe2Phases --log_dir ./logs --expname test --train_paths ./data/path_datasets/codex-small/train/ --valid_paths ./data/path_datasets/codex-small/val/ --test_paths ./data/path_datasets/codex-small/test/ --max_ppt 2 --batch_size 1024 --loss_weight 0 --nhead 2 --num_encoder_layers 1 --dim_feedforward 256 --embedding_dim 64 --corruption e --patience 5 --dropout 0.1 --lrate 1e-3 --device cuda --num_devices 1 --num_workers 16 --ent_aggregation transformer --lp_loss_fn ce --accumulate_gradient 8 --label_smoothing 0.01 --node_projector dummy --path_setup 20_10 --num_agg_layers 1 --seed 7 --use_manual_optimization --link_head_detached --candidates_cap 1000000`
