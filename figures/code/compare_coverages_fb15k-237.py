...
def create_compare_coverage_vs_avg_group_size_plot(csv_paths, labels=None, save_dir="./figures", filename="compare_coverage_vs_avg_group_size.pgf", relative_divisor=None):
    ...
    ax1.legend(
        ...
        final_labels,
        ncol=4,
        loc='center right', # <-- Placed inside (try 'best' or 'center right' if this covers data)
    ...
    rect = Rectangle(
        (3.04e6, 0.349),      # (x, y) Bottom-Left corner
        5.462e6,                # width
        0.307,               # height
...
if __name__ == "__main__":
    ...
    csv_paths = [
        "./logs/Final/Fb15k237/pathe2Phases/RelationBceTailBce/version_0/figures/coverage_vs_size_results.csv",
        "./logs/Final/Fb15k237/pathe2Phases/RelationHTailH/version_0/figures/coverage_vs_size_results.csv",
        "./logs/Final/Fb15k237/pathe2Phases/RelationHurdleTailBce/version_0/figures/coverage_vs_size_results.csv",
        "./logs/Final/Fb15k237/pathe2Phases/RelationNBTailBce/version_0/figures/coverage_vs_size_results.csv",
        "./logs/Final/Fb15k237/pathe2Phases/RelationNBTailNB/version_0/figures/coverage_vs_size_results.csv",
        "./logs/Final/Fb15k237/pathe2Phases/RelationPTailBce/version_0/figures/coverage_vs_size_results.csv",
        "./logs/Final/Fb15k237/pathe2Phases/RelationPTailP/version_0/figures/coverage_vs_size_results.csv"
    ]
    labels = [
        ("BCE", "BCE"),
        ("Hurdle", "Hurdle"),
    ...
    create_compare_coverage_vs_avg_group_size_plot(csv_paths, labels, filename="fb15k-237_compare_macro.pgf", relative_divisor=20438)