import torch
from PathE.pathe.figures import create_entity_occurrence_figure, create_relation_occurrence_figure, plot_relation_count_dispersion, plot_entity_count_dispersion
...
plot_entity_count_dispersion(triples, save_dir=f"./figures/{filename_end}", filename=f"entity_dispersion_{filename_end}.svg")
